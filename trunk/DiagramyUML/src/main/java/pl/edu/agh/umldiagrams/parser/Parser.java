...
//			ParsedDiagramController.getInstance().print();
    ...
    public static void main(String[] args) throws ConfigException, ParseException {

        Config config1 = new Config("resources/conf.xml");
        Parser parser = new Parser(config1);
        parser.parseFile("resources/wyplata.xml");
        parser.getParsedDiagramController().print();
    }
}
